...
def register():
    ...
    page_title       = 'Register - Flask Solid State | AppSeed App Generator'
    page_description = 'Open-Source Flask Solid State, registration page.'
...
def login():
    ...
    page_title = 'Login - Flask Solid State | AppSeed App Generator'
    page_description = 'Open-Source Flask Solid State, login page.'
